...
class Event:
    def event_call(self):
        ...
        @rtype: None
        >> event_call()
        *Function randomly picks an event out of the 2 listed*
        >> event_call[]
    ...
    def event_monster(self):
        ...
        print(
            "Name:", e.name, "\nHealth:", e.health, "\nAttacks:", e.attack1, e.attack2, e.attack3, e.attack4,
            e.attack5,
...
player1 = Player(name="Player.1", health=500, attack1=10, attack2=15, attack3=40,
                     player_heal=30, player_instant_death=999999999999999, description="The Player you control")
players = [player1]
p = players.pop(0)  # player class, all player actions are start with 'p.___'.


ev = Event()  # variable, for the event class. Methods being called in this class start with 'ev.___'.
